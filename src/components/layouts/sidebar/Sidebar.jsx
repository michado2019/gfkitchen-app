              ...
              <div className="sidebarLocation-contents" key={locationDatum.id}>
                <div className="sidebarLocation-content">
                  ...
                  <div className="sidebarLocation-content2">
                    <h4 className="sidebarLocation-geo">
                      {locationDatum.geo.geo_one},{" "}
                    </h4>{" "}
                    <h4>{locationDatum.geo.geo_two}</h4>
                    <h4 className="sidebarLocation-state">
                      {locationDatum.state},
                    </h4>
                    <h4 className="sidebarLocation-country">
                      {locationDatum.country}
                    </h4>
                  </div>
                  <ArrowForwardIos
                    className="sidebarLocation-arrow"
                ...
                <div className="sidebarAdmin-div">
                  <Link className="sidebarAdmin" to="/admin">
                    Admin
                  </Link>
                </div>
              </div>
